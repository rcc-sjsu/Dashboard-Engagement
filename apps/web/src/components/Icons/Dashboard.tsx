...
const Dashboard = ({ className, ...props }: Props) => {
  const topLeftClasses =
    "transition-transform duration-300 ease-out [transform-box:fill-box] [transform-origin:center] will-change-transform scale-[1.08] group-hover/menu-item:scale-[0.92]"
  const bottomLeftClasses =
    "transition-transform duration-300 ease-out delay-75 [transform-box:fill-box] [transform-origin:center] will-change-transform scale-[0.95] group-hover/menu-item:scale-[1.05]"
  const bottomRightClasses =
    "transition-transform duration-300 ease-out delay-100 [transform-box:fill-box] [transform-origin:center] will-change-transform scale-[0.92] group-hover/menu-item:scale-[1.08]"
  const topRightClasses =
    "transition-transform duration-300 ease-out delay-150 [transform-box:fill-box] [transform-origin:center] will-change-transform scale-[1.04] group-hover/menu-item:scale-[0.96]"
